...
def get_security_from_env(security: Any, security_class: Any) -> Optional[BaseModel]:
    ...
    if os.getenv("ZENDESK_USERNAME"):
        security_dict["username"] = os.getenv("ZENDESK_USERNAME")

    if os.getenv("ZENDESK_PASSWORD"):
        security_dict["password"] = os.getenv("ZENDESK_PASSWORD")
