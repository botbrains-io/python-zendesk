...
class TicketSkips(BaseSDK):
    def record_new_skip(
    ...
    ) -> models.TicketSkipCreation:
        r"""Record a New Skip for the Current User
        ...
        * Agents
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(models.TicketSkipCreation, http_res)
    ...
    async def record_new_skip_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def list_ticket_skips(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.ListTicketSkipsResponse]:
        r"""List Ticket Skips
        ...
        * Agents retrieving their own skips
        ...
        :param user_id: User ID of an agent
        ...
        request = models.ListTicketSkipsRequest(
            user_id=user_id,
        ...
        req = self._build_request(
            method="GET",
            path="/api/v2/users/{user_id}/skips",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        def next_func() -> Optional[models.ListTicketSkipsResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListTicketSkipsResponse(
                result=unmarshal_json_response(models.TicketSkipsResponse, http_res),
                next=next_func,
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
    ...
    async def list_ticket_skips_async(
        self,
        *,
        user_id: int,
        sort_order: Optional[models.TicketSortOrder] = None,
