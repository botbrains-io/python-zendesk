...
class OAuthClients(BaseSDK):
    def list_o_auth_clients(
    ...
    ) -> Optional[models.ListOAuthClientsResponse]:
        r"""List Clients
        ...
        * Admins
        ...
        request = models.ListOAuthClientsRequest(
        ...
        def next_func() -> Optional[models.ListOAuthClientsResponse]:
            ...
            return self.list_o_auth_clients(
                page_before=page_before,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListOAuthClientsResponse(
                result=unmarshal_json_response(models.OAuthClientsResponse, http_res),
                next=next_func,
            )
    ...
    async def list_o_auth_clients_async(
        self,
        *,
        page_before: Optional[str] = None,
        page_after: Optional[str] = None,
    ...
    def create_o_auth_client(
        ...
        * Admins
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(models.OauthClientResponse, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
    ...
    def show_client(
        ...
        * Admins
        ...
        :param oauth_client_id: The ID of the OAuth client
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.ShowClientRequest(
            oauth_client_id=oauth_client_id,
        )

        req = self._build_request(
            method="GET",
            path="/api/v2/oauth/clients/{oauth_client_id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def client_generate_secret(
        ...
        * Admins
        ...
        request = models.ClientGenerateSecretRequest(
            oauth_client_id=oauth_client_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="ClientGenerateSecret",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    async def client_generate_secret_async(
        self,
        *,
        oauth_client_id: int,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
