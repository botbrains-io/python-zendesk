...
class ConversationLog(BaseSDK):
    def list_conversation_log_for_ticket(
        self,
        *,
        ticket_id: int,
    ...
    ) -> Optional[models.ListConversationLogForTicketResponse]:
        r"""List Conversation log for Ticket
        ...
        * Agents
        ...
        request = models.ListConversationLogForTicketRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="ListConversationLogForTicket",
                oauth2_scopes=None,
        ...
        def next_func() -> Optional[models.ListConversationLogForTicketResponse]:
            ...
            return self.list_conversation_log_for_ticket(
                ticket_id=ticket_id,
                page_before=page_before,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListConversationLogForTicketResponse(
                result=unmarshal_json_response(
                    models.ConversationLogResponse, http_res
                ),
                next=next_func,
            )
    ...
    async def list_conversation_log_for_ticket_async(
        self,
        *,
        ticket_id: int,
        page_before: Optional[str] = None,
