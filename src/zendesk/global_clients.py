...
class GlobalClients(BaseSDK):
    def list_global_o_auth_clients(
        self,
        *,
    ...
    ) -> Optional[models.ListGlobalOAuthClientsResponse]:
        r"""List Global OAuth Clients
        ...
        * Admins
        ...
        request = models.ListGlobalOAuthClientsRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="ListGlobalOAuthClients",
                oauth2_scopes=None,
        ...
        def next_func() -> Optional[models.ListGlobalOAuthClientsResponse]:
            ...
            return self.list_global_o_auth_clients(
                page_before=page_before,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListGlobalOAuthClientsResponse(
                result=unmarshal_json_response(models.GlobalClientsResponse, http_res),
                next=next_func,
            )
    ...
    async def list_global_o_auth_clients_async(
        self,
        *,
        page_before: Optional[str] = None,
        page_after: Optional[str] = None,
