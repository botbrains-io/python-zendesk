...
class SuspendedTickets(BaseSDK):
    def list_suspended_tickets(
    ...
    ) -> Optional[models.ListSuspendedTicketsResponse]:
        r"""List Suspended Tickets
        ...
        * Cursor pagination
        ...
        :param sort_by: The field to sort the suspended tickets by. One of \"author_email\", \"cause\", \"created_at\", or \"subject\"
        :param sort_order: The order in which to sort the suspended tickets.  This can take value `asc` or `desc`.
        ...
        request = models.ListSuspendedTicketsRequest(
            sort_by=sort_by,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="ListSuspendedTickets",
                oauth2_scopes=None,
        ...
        def next_func() -> Optional[models.ListSuspendedTicketsResponse]:
            ...
            return self.list_suspended_tickets(
                sort_by=sort_by,
                sort_order=sort_order,
                page_before=page_before,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListSuspendedTicketsResponse(
                result=unmarshal_json_response(
                    models.SuspendedTicketsResponse, http_res
                ),
                next=next_func,
            )
    ...
    async def list_suspended_tickets_async(
        self,
        *,
        sort_by: Optional[str] = None,
        sort_order: Optional[str] = None,
    ...
    def show_suspended_tickets(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.SuspendedTicketsResponse:
        r"""Show Suspended Ticket
        ...
        * Unrestricted agents on all other plans
        ...
        :param id: id of the suspended ticket
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.ShowSuspendedTicketsRequest(
            id=id,
        )

        req = self._build_request(
            method="GET",
            path="/api/v2/suspended_tickets/{id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="ShowSuspendedTickets",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.SuspendedTicketsResponse, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
    ...
    async def show_suspended_tickets_async(
        self,
        *,
        id: float,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def delete_suspended_ticket(
        ...
        * Unrestricted agents
        ...
        request = models.DeleteSuspendedTicketRequest(
            id=id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="DeleteSuspendedTicket",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    async def delete_suspended_ticket_async(
        self,
        *,
        id: float,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def recover_suspended_ticket(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.RecoverSuspendedTicketResponse:
        r"""Recover Suspended Ticket
        ...
        * Unrestricted agents on all other plans
        ...
        request = models.RecoverSuspendedTicketRequest(
            id=id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="RecoverSuspendedTicket",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.RecoverSuspendedTicketResponse, http_res
            )
        if utils.match_response(http_res, "422", "application/json"):
            response_data = unmarshal_json_response(
                errors.RecoverSuspendedTicketUnprocessableContentResponseErrorData,
                http_res,
            )
            raise errors.RecoverSuspendedTicketUnprocessableContentResponseError(
    ...
    async def recover_suspended_ticket_async(
        self,
        *,
        id: float,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def suspended_tickets_attachments(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.SuspendedTicketsAttachmentsResponse:
        r"""Suspended Ticket Attachments
        ...
        * Unrestricted agents on all other plans
        ...
        req = self._build_request(
            method="POST",
            path="/api/v2/suspended_tickets/attachments",
            base_url=base_url,
            url_variables=url_variables,
            request=None,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="SuspendedTicketsAttachments",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.SuspendedTicketsAttachmentsResponse, http_res
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError("API error occurred", http_res, http_res_text)
    ...
    async def suspended_tickets_attachments_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def delete_suspended_tickets(
        ...
        *,
        ...
        r"""Delete Multiple Suspended Tickets
        ...
        * Unrestricted agents on all other plans
        ...
        :param ids: A comma separated list of ids of suspended tickets to delete.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.DeleteSuspendedTicketsRequest(
            ids=ids,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="DeleteSuspendedTickets",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    async def delete_suspended_tickets_async(
        self,
        *,
        ids: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def export_suspended_tickets(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.SuspendedTicketsExportResponse:
        r"""Export Suspended Tickets
        ...
        * Unrestricted agents on all other plans
        ...
        req = self._build_request(
            method="POST",
            path="/api/v2/suspended_tickets/export",
            base_url=base_url,
            url_variables=url_variables,
            request=None,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="ExportSuspendedTickets",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.SuspendedTicketsExportResponse, http_res
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError("API error occurred", http_res, http_res_text)
    ...
    async def export_suspended_tickets_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def recover_suspended_tickets(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.RecoverSuspendedTicketsResponse:
        r"""Recover Multiple Suspended Tickets
        ...
        * Unrestricted agents on all other plans
        ...
        :param ids: A comma separated list of ids of suspended tickets to recover.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.RecoverSuspendedTicketsRequest(
            ids=ids,
        )

        req = self._build_request(
            method="PUT",
            path="/api/v2/suspended_tickets/recover_many",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="RecoverSuspendedTickets",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.RecoverSuspendedTicketsResponse, http_res
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError("API error occurred", http_res, http_res_text)
    ...
    async def recover_suspended_tickets_async(
        self,
        *,
        ids: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
