...
class Targets(BaseSDK):
    def list_targets(
        ...
        * Agents
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.TargetsResponse, http_res)
    ...
    def create_target(
        ...
        * Admins
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(models.TargetResponse, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
    ...
    def show_target(
        ...
        * Agents
        ...
        request = models.ShowTargetRequest(
            target_id=target_id,
        )

        req = self._build_request(
            method="GET",
            path="/api/v2/targets/{target_id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
