...
class UserPasswords(BaseSDK):
    def set_user_password(
        ...
        * Admins
        ...
        request = models.SetUserPasswordRequest(
            user_id=user_id,
        )
    ...
    def change_own_password(
        ...
        * End Users
        ...
        request = models.ChangeOwnPasswordRequest(
            user_id=user_id,
        )
    ...
    async def change_own_password_async(
        self,
        *,
        user_id: int,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def get_user_password_requirements(
        self,
        *,
        user_id: int,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.UserPasswordRequirementsResponse:
        r"""List password requirements
        ...
        * End Users
        ...
        request = models.GetUserPasswordRequirementsRequest(
            user_id=user_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="GetUserPasswordRequirements",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.UserPasswordRequirementsResponse, http_res
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError("API error occurred", http_res, http_res_text)
    ...
    async def get_user_password_requirements_async(
        self,
        *,
        user_id: int,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
