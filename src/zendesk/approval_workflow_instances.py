...
class ApprovalWorkflowInstances(BaseSDK):
    def create_approval_workflow_instance(
        self,
        *,
    ...
    ) -> models.ApprovalWorkflowInstanceObject:
        r"""Create Approval Workflow Instance
        ...
        * Agents
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="CreateApprovalWorkflowInstance",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(
                models.ApprovalWorkflowInstanceObject, http_res
            )
    ...
    async def create_approval_workflow_instance_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
