...
class AccountSettings(BaseSDK):
    ...
    ) -> models.AccountSettingsResponse:
        r"""Show Settings
        ...
        * Agents
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="ShowAccountSettings",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.AccountSettingsResponse, http_res)
    ...
    async def show_account_settings_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    async def update_account_settings_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
