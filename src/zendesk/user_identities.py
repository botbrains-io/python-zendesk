...
class UserIdentities(BaseSDK):
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListUserIdentitiesResponse(
                result=utils.unmarshal_json(
                    http_res.text, models.UserIdentitiesResponse
                ),
                next=next_func,
            )
    ...
    def create_user_identity(
        ...
        * Agents
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(http_res.text, models.UserIdentityResponse)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def make_user_identity_primary(
        ...
        * Verified end users
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.UserIdentitiesResponse)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
