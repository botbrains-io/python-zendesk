...
class OrganizationFieldsSDK(BaseSDK):
    def list_organization_fields(
        self,
        *,
    ...
    ) -> Optional[models.ListOrganizationFieldsResponse]:
        r"""List Organization Fields
        ...
        * Agents
        ...
        request = models.ListOrganizationFieldsRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="ListOrganizationFields",
                oauth2_scopes=None,
        ...
        def next_func() -> Optional[models.ListOrganizationFieldsResponse]:
            ...
            return self.list_organization_fields(
                page_before=page_before,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListOrganizationFieldsResponse(
                result=unmarshal_json_response(
                    models.OrganizationFieldsResponse, http_res
                ),
                next=next_func,
            )
    ...
    async def list_organization_fields_async(
        self,
        *,
        page_before: Optional[str] = None,
        page_after: Optional[str] = None,
    ...
    def create_organization_field(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.OrganizationFieldResponse:
        r"""Create Organization Field
        ...
        * Admins
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="CreateOrganizationField",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(models.OrganizationFieldResponse, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
    ...
    async def create_organization_field_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def reorder_organization_field(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        * Admins
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="ReorderOrganizationField",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    async def reorder_organization_field_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
