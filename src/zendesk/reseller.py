...
class Reseller(BaseSDK):
    def create_trial_account(
        ...
        *,
    ...
    ) -> models.TrialAccountResponse:
        r"""Create Trial Account
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(models.TrialAccountResponse, http_res)
    ...
    async def create_trial_account_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def verify_subdomain_availability(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.VerifySubdomainAvailabilityResponse:
        r"""Verify Subdomain Availability
        ...
        request = models.VerifySubdomainAvailabilityRequest(
            subdomain=subdomain,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.VerifySubdomainAvailabilityResponse, http_res
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError("API error occurred", http_res, http_res_text)
    ...
    async def verify_subdomain_availability_async(
        self,
        *,
        subdomain: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
