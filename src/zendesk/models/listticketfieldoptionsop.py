...
class ListTicketFieldOptionsRequestTypedDict(TypedDict):
    ticket_field_id: int
...
class ListTicketFieldOptionsRequest(BaseModel):
...
class ListTicketFieldOptionsResponseTypedDict(TypedDict):
    result: CustomFieldOptionsResponseTypedDict


class ListTicketFieldOptionsResponse(BaseModel):
    next: Callable[[], Optional[ListTicketFieldOptionsResponse]]

    result: CustomFieldOptionsResponse
