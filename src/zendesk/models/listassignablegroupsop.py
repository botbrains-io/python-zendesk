...
class ListAssignableGroupsRequestTypedDict(TypedDict):
...
class ListAssignableGroupsRequest(BaseModel):
...
class ListAssignableGroupsResponseTypedDict(TypedDict):
    result: GroupsResponseTypedDict


class ListAssignableGroupsResponse(BaseModel):
    next: Callable[[], Optional[ListAssignableGroupsResponse]]
