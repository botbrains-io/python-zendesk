...
class ListTicketsFromViewRequestTypedDict(TypedDict):
    view_id: int
    ...
    r"""Sort or group the tickets by a column in the [View columns](#view-columns) table. The `subject` and `submitter` columns are not supported"""
    sort_order: NotRequired[str]
    r"""One of \"asc\" or \"desc\". Defaults to \"asc\" for alphabetical and position sort, \"desc\" for all others"""


class ListTicketsFromViewRequest(BaseModel):
    view_id: Annotated[
...
class ListTicketsFromViewResponseTypedDict(TypedDict):
    result: TicketsResponseTypedDict


class ListTicketsFromViewResponse(BaseModel):
    next: Callable[[], Optional[ListTicketsFromViewResponse]]
