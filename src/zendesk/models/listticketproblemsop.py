...
class ListTicketProblemsRequestTypedDict(TypedDict):
...
class ListTicketProblemsRequest(BaseModel):
...
class ListTicketProblemsResponseTypedDict(TypedDict):
    result: Dict[str, Any]


class ListTicketProblemsResponse(BaseModel):
    next: Callable[[], Optional[ListTicketProblemsResponse]]
