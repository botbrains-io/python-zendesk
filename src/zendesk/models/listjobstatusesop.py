...
class ListJobStatusesRequestTypedDict(TypedDict):
...
class ListJobStatusesRequest(BaseModel):
...
class ListJobStatusesResponseTypedDict(TypedDict):
    result: JobStatusesResponseTypedDict


class ListJobStatusesResponse(BaseModel):
    next: Callable[[], Optional[ListJobStatusesResponse]]

    result: JobStatusesResponse
