...
class ListOAuthTokensRequestTypedDict(TypedDict):
...
class ListOAuthTokensRequest(BaseModel):
    client_id: Annotated[
        Optional[int],
...
class ListOAuthTokensResponseTypedDict(TypedDict):
    result: OAuthTokensResponseTypedDict


class ListOAuthTokensResponse(BaseModel):
    next: Callable[[], Optional[ListOAuthTokensResponse]]
