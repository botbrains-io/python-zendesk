...
class ListDynamicContentsRequestTypedDict(TypedDict):
...
class ListDynamicContentsRequest(BaseModel):
...
class ListDynamicContentsResponseTypedDict(TypedDict):
    result: DynamicContentsResponseTypedDict


class ListDynamicContentsResponse(BaseModel):
    next: Callable[[], Optional[ListDynamicContentsResponse]]

    result: DynamicContentsResponse
