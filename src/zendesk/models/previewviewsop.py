...
class PreviewViewsRequestTypedDict(TypedDict):
...
class PreviewViewsRequest(BaseModel):
...
class PreviewViewsResponseTypedDict(TypedDict):
    result: ViewResponseTypedDict


class PreviewViewsResponse(BaseModel):
    next: Callable[[], Optional[PreviewViewsResponse]]
