...
class ListOrganizationMembershipsResponseTypedDict(TypedDict):
    result: OrganizationMembershipsResponseTypedDict


class ListOrganizationMembershipsResponse(BaseModel):
    next: Callable[[], Optional[ListOrganizationMembershipsResponse]]

    result: OrganizationMembershipsResponse
