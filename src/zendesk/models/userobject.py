...
class UserObjectUserForEndUserTypedDict(TypedDict):
    name: str
...
class UserObjectUserForEndUser(BaseModel):
...
class UserObjectUsersTypedDict(TypedDict):
    name: str
    r"""The user's name"""
...
class UserObjectUsers(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True, arbitrary_types_allowed=True, extra="allow"
    )
    __pydantic_extra__: Dict[str, Any] = pydantic.Field(init=False)
...
UserObjectTypedDict = TypeAliasType(
    "UserObjectTypedDict",
    Union[UserObjectUserForEndUserTypedDict, UserObjectUsersTypedDict],
)


UserObject = TypeAliasType(
    "UserObject", Union[UserObjectUserForEndUser, UserObjectUsers]
)
