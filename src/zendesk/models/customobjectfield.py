...
class CustomObjectFieldRelationshipFilterTypedDict(TypedDict):
    r"""A filter definition that allows your autocomplete to filter down results"""


class CustomObjectFieldRelationshipFilter(BaseModel):
    r"""A filter definition that allows your autocomplete to filter down results"""


class CustomObjectFieldTypedDict(TypedDict):
    key: str
    ...
    relationship_filter: NotRequired[CustomObjectFieldRelationshipFilterTypedDict]
    r"""A filter definition that allows your autocomplete to filter down results"""
    ...
    properties: NotRequired[CustomObjectFieldPropertiesObjectTypedDict]
...
class CustomObjectField(BaseModel):
    ...
    relationship_filter: Optional[CustomObjectFieldRelationshipFilter] = None
    r"""A filter definition that allows your autocomplete to filter down results"""
    ...
    properties: Optional[CustomObjectFieldPropertiesObject] = None
    r"""A set of properties which describe the standard::name field's autonumbering and uniqueness behavior. Autonumbering and uniqueness can't be used together"""
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = set(["regexp_for_validation"])
...
class CustomObjectFieldInputTypedDict(TypedDict):
    key: str
    r"""A unique key that identifies this custom field. This is used for updating the field and referencing in placeholders. The key must consist of only letters, numbers, and underscores. It can't be only numbers"""
    title: str
    r"""The title of the custom field"""
    ...
    active: NotRequired[bool]
    r"""If true, this field is available for use"""
    custom_field_options: NotRequired[List[CustomFieldOptionObjectInputTypedDict]]
    r"""Required and presented for a custom field of type \"dropdown\". Each option is represented by an object with a `name` and `value` property"""
    description: NotRequired[str]
    r"""User-defined description of this field's purpose"""
    position: NotRequired[int]
...
class CustomObjectFieldInput(BaseModel):
    key: str
    r"""A unique key that identifies this custom field. This is used for updating the field and referencing in placeholders. The key must consist of only letters, numbers, and underscores. It can't be only numbers"""
    ...
    custom_field_options: Optional[List[CustomFieldOptionObjectInput]] = None
    r"""Required and presented for a custom field of type \"dropdown\". Each option is represented by an object with a `name` and `value` property"""
