...
class ListGroupMembershipsRequestTypedDict(TypedDict):
...
class ListGroupMembershipsResponseTypedDict(TypedDict):
    result: GroupMembershipsResponseTypedDict


class ListGroupMembershipsResponse(BaseModel):
    next: Callable[[], Optional[ListGroupMembershipsResponse]]
