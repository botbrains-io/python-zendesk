...
from .oauthclientsresponse import OAuthClientsResponse, OAuthClientsResponseTypedDict
import pydantic
...
class ListOAuthClientsRequestTypedDict(TypedDict):
...
class ListOAuthClientsRequest(BaseModel):
...
class ListOAuthClientsResponseTypedDict(TypedDict):
    result: OAuthClientsResponseTypedDict


class ListOAuthClientsResponse(BaseModel):
    next: Callable[[], Optional[ListOAuthClientsResponse]]

    result: OAuthClientsResponse
