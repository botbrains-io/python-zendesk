...
class ListTicketIncidentsRequestTypedDict(TypedDict):
    ticket_id: int
...
class ListTicketIncidentsRequest(BaseModel):
    ticket_id: Annotated[
...
class ListTicketIncidentsResponseTypedDict(TypedDict):
    result: Dict[str, Any]


class ListTicketIncidentsResponse(BaseModel):
    next: Callable[[], Optional[ListTicketIncidentsResponse]]
