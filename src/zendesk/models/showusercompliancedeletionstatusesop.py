...
class ShowUserComplianceDeletionStatusesRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["page[before]", "page[after]", "page[size]", "application"]
        )
...
class ShowUserComplianceDeletionStatusesResponseTypedDict(TypedDict):
    result: ComplianceDeletionStatusesResponseTypedDict


class ShowUserComplianceDeletionStatusesResponse(BaseModel):
    next: Callable[[], Optional[ShowUserComplianceDeletionStatusesResponse]]

    result: ComplianceDeletionStatusesResponse
