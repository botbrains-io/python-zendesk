...
class ListOrganizationFieldsRequestTypedDict(TypedDict):
...
class ListOrganizationFieldsRequest(BaseModel):
...
class ListOrganizationFieldsResponseTypedDict(TypedDict):
    result: OrganizationFieldsResponseTypedDict


class ListOrganizationFieldsResponse(BaseModel):
    next: Callable[[], Optional[ListOrganizationFieldsResponse]]

    result: OrganizationFieldsResponse
