...
class ListConversationLogForTicketRequestTypedDict(TypedDict):
    ticket_id: int
...
class ListConversationLogForTicketRequest(BaseModel):
    ticket_id: Annotated[
...
class ListConversationLogForTicketResponseTypedDict(TypedDict):
    result: ConversationLogResponseTypedDict


class ListConversationLogForTicketResponse(BaseModel):
    next: Callable[[], Optional[ListConversationLogForTicketResponse]]

    result: ConversationLogResponse
