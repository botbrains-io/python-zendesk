...
class ListSuspendedTicketsResponseTypedDict(TypedDict):
    result: SuspendedTicketsResponseTypedDict


class ListSuspendedTicketsResponse(BaseModel):
    next: Callable[[], Optional[ListSuspendedTicketsResponse]]

    result: SuspendedTicketsResponse
