...
class ActorUserForEndUserTypedDict(TypedDict):
    name: str
...
class ActorUserForEndUser(BaseModel):
...
class ActorUsersTypedDict(TypedDict):
    name: str
    r"""The user's name"""
...
class ActivityObjectUserUserForEndUserTypedDict(TypedDict):
    name: str
    r"""The name of the user"""
    created_at: NotRequired[str]
    r"""The time the user was created"""
...
class ActivityObjectUserUserForEndUser(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True, arbitrary_types_allowed=True, extra="allow"
    )
    __pydantic_extra__: Dict[str, Any] = pydantic.Field(init=False)
...
class ActivityObjectUserUsersTypedDict(TypedDict):
    name: str
    r"""The user's name"""
    active: NotRequired[bool]
    r"""false if the user has been deleted"""
...
class ActivityObjectUserUsers(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True, arbitrary_types_allowed=True, extra="allow"
    )
    __pydantic_extra__: Dict[str, Any] = pydantic.Field(init=False)
...
ActorTypedDict = TypeAliasType(
    "ActorTypedDict", Union[ActorUserForEndUserTypedDict, ActorUsersTypedDict]
)
r"""The full user record of the user responsible for the ticket activity. See [Users](/api-reference/ticketing/users/users/)"""


Actor = TypeAliasType("Actor", Union[ActorUserForEndUser, ActorUsers])
r"""The full user record of the user responsible for the ticket activity. See [Users](/api-reference/ticketing/users/users/)"""


ActivityObjectUserTypedDict = TypeAliasType(
    "ActivityObjectUserTypedDict",
    Union[ActivityObjectUserUserForEndUserTypedDict, ActivityObjectUserUsersTypedDict],
)
r"""The full user record of the agent making the request. See [Users](/api-reference/ticketing/users/users/)"""


ActivityObjectUser = TypeAliasType(
    "ActivityObjectUser",
    Union[ActivityObjectUserUserForEndUser, ActivityObjectUserUsers],
)
r"""The full user record of the agent making the request. See [Users](/api-reference/ticketing/users/users/)"""


class ActivityObjectTypedDict(TypedDict):
    actor: NotRequired[ActorTypedDict]
    r"""The full user record of the user responsible for the ticket activity. See [Users](/api-reference/ticketing/users/users/)"""
    actor_id: NotRequired[int]
    r"""The id of the user responsible for the ticket activity. An `actor_id` of \"-1\" is a Zendesk system user, such as an automations action."""
    created_at: NotRequired[str]
    r"""When the record was created"""
    id: NotRequired[int]
    r"""Automatically assigned on creation"""
    object: NotRequired[Dict[str, Any]]
    r"""The content of the activity. Can be a ticket, comment, or change."""
    target: NotRequired[Dict[str, Any]]
    r"""The target of the activity, a ticket."""
    title: NotRequired[str]
    r"""Description of the activity"""
    updated_at: NotRequired[str]
    r"""When the record was last updated"""
    url: NotRequired[str]
    r"""The API url of the activity"""
    user: NotRequired[ActivityObjectUserTypedDict]
    r"""The full user record of the agent making the request. See [Users](/api-reference/ticketing/users/users/)"""
    user_id: NotRequired[int]
    r"""The id of the agent making the request"""
    verb: NotRequired[str]
    r"""The type of activity. Can be \"tickets.assignment\", \"tickets.comment\", or \"tickets.priority_increase\" """
...
class ActivityObject(BaseModel):
    ...
    user: Optional[ActivityObjectUser] = None
    r"""The full user record of the agent making the request. See [Users](/api-reference/ticketing/users/users/)"""
