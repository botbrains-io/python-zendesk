...
class DynamicContentListVariantsRequestTypedDict(TypedDict):
...
class DynamicContentListVariantsRequest(BaseModel):
...
class DynamicContentListVariantsResponseTypedDict(TypedDict):
    result: DynamicContentVariantsResponseTypedDict


class DynamicContentListVariantsResponse(BaseModel):
    next: Callable[[], Optional[DynamicContentListVariantsResponse]]

    result: DynamicContentVariantsResponse
