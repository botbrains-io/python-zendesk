...
class ListAssignableGroupMembershipsRequestTypedDict(TypedDict):
...
class ListAssignableGroupMembershipsRequest(BaseModel):
...
class ListAssignableGroupMembershipsResponseTypedDict(TypedDict):
    result: GroupMembershipsResponseTypedDict


class ListAssignableGroupMembershipsResponse(BaseModel):
    next: Callable[[], Optional[ListAssignableGroupMembershipsResponse]]

    result: GroupMembershipsResponse
