...
class ListOrganizationSubscriptionsRequestTypedDict(TypedDict):
...
class ListOrganizationSubscriptionsRequest(BaseModel):
...
class ListOrganizationSubscriptionsResponseTypedDict(TypedDict):
    result: OrganizationSubscriptionsResponseTypedDict


class ListOrganizationSubscriptionsResponse(BaseModel):
    next: Callable[[], Optional[ListOrganizationSubscriptionsResponse]]

    result: OrganizationSubscriptionsResponse
