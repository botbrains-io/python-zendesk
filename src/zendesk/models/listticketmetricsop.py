...
from .ticketmetricsresponse import TicketMetricsResponse, TicketMetricsResponseTypedDict
import pydantic
...
class ListTicketMetricsRequestTypedDict(TypedDict):
...
class ListTicketMetricsRequest(BaseModel):
...
class ListTicketMetricsResponseTypedDict(TypedDict):
    result: TicketMetricsResponseTypedDict


class ListTicketMetricsResponse(BaseModel):
    next: Callable[[], Optional[ListTicketMetricsResponse]]

    result: TicketMetricsResponse
