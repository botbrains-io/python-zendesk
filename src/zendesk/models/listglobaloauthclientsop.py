...
from .globalclientsresponse import GlobalClientsResponse, GlobalClientsResponseTypedDict
import pydantic
...
class ListGlobalOAuthClientsRequestTypedDict(TypedDict):
...
class ListGlobalOAuthClientsRequest(BaseModel):
...
class ListGlobalOAuthClientsResponseTypedDict(TypedDict):
    result: GlobalClientsResponseTypedDict


class ListGlobalOAuthClientsResponse(BaseModel):
    next: Callable[[], Optional[ListGlobalOAuthClientsResponse]]

    result: GlobalClientsResponse
