...
BookmarkObjectValueTypedDict = TypeAliasType(
    "BookmarkObjectValueTypedDict", Union[str, int, bool]
)
r"""The value of the custom field"""


BookmarkObjectValue = TypeAliasType("BookmarkObjectValue", Union[str, int, bool])
r"""The value of the custom field"""


class BookmarkObjectCustomFieldTypedDict(TypedDict):
    id: NotRequired[int]
    r"""The id of the custom field"""
    value: NotRequired[Nullable[BookmarkObjectValueTypedDict]]
    r"""The value of the custom field"""


class BookmarkObjectCustomField(BaseModel):
    id: Optional[int] = None
    r"""The id of the custom field"""

    value: OptionalNullable[BookmarkObjectValue] = UNSET
    r"""The value of the custom field"""
...
BookmarkObjectPriority = Literal[
    "urgent",
    "high",
    "normal",
    "low",
...
class BookmarkObjectViaTypedDict(TypedDict):
...
class BookmarkObjectVia(BaseModel):
    r"""For more information, see the [Via object reference](/documentation/ticketing/reference-guides/via-object-reference)"""
...
class BookmarkObjectTicketTypedDict(TypedDict):
    requester_id: int
    ...
    custom_fields: NotRequired[List[BookmarkObjectCustomFieldTypedDict]]
    ...
    priority: NotRequired[BookmarkObjectPriority]
    r"""The urgency with which the ticket should be addressed"""
    ...
    status: NotRequired[BookmarkObjectStatus]
    r"""The state of the ticket.
    ...
    type: NotRequired[BookmarkObjectType]
    r"""The type of this ticket"""
    ...
    via: NotRequired[BookmarkObjectViaTypedDict]
    r"""For more information, see the [Via object reference](/documentation/ticketing/reference-guides/via-object-reference)"""
...
class BookmarkObjectTicket(BaseModel):
    requester_id: int
    r"""The user who requested this ticket"""
    ...
    custom_fields: Optional[List[BookmarkObjectCustomField]] = None
    r"""Custom fields for the ticket. See [Setting custom field values](/documentation/ticketing/managing-tickets/creating-and-updating-tickets#setting-custom-field-values)"""
    ...
    priority: Optional[BookmarkObjectPriority] = None
    r"""The urgency with which the ticket should be addressed"""
    ...
    status: Optional[BookmarkObjectStatus] = None
    r"""The state of the ticket.
    ...
    type: Optional[BookmarkObjectType] = None
    r"""The type of this ticket"""
    ...
    via: Optional[BookmarkObjectVia] = None
    r"""For more information, see the [Via object reference](/documentation/ticketing/reference-guides/via-object-reference)"""
...
class BookmarkObjectTypedDict(TypedDict):
    created_at: NotRequired[datetime]
    r"""The time the bookmark was created"""
    id: NotRequired[int]
    r"""Automatically assigned when the bookmark is created"""
    ticket: NotRequired[BookmarkObjectTicketTypedDict]
    url: NotRequired[str]
    r"""The API url of this bookmark"""
...
class BookmarkObject(BaseModel):
    ...
    ticket: Optional[BookmarkObjectTicket] = None
