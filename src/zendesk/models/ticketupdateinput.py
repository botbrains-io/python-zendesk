...
TicketUpdateInputValueTypedDict = TypeAliasType(
    "TicketUpdateInputValueTypedDict", Union[str, int, bool, List[str], float]
)
r"""The value of the custom field"""


TicketUpdateInputValue = TypeAliasType(
    "TicketUpdateInputValue", Union[str, int, bool, List[str], float]
)
r"""The value of the custom field"""
...
class TicketUpdateInputCustomFieldTypedDict(TypedDict):
    ...
    value: NotRequired[TicketUpdateInputValueTypedDict]
    r"""The value of the custom field"""
...
class TicketUpdateInputCustomField(BaseModel):
    ...
    value: Optional[TicketUpdateInputValue] = None
    r"""The value of the custom field"""


TicketUpdateInputPriority = Literal[
    "urgent",
    "high",
    "normal",
    "low",
...
TicketUpdateInputStatus = Literal[
    "new",
    "open",
    "pending",
    "hold",
