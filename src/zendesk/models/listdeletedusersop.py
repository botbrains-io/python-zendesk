...
from .deletedusersresponse import DeletedUsersResponse, DeletedUsersResponseTypedDict
import pydantic
...
class ListDeletedUsersRequestTypedDict(TypedDict):
...
class ListDeletedUsersRequest(BaseModel):
...
class ListDeletedUsersResponseTypedDict(TypedDict):
    result: DeletedUsersResponseTypedDict


class ListDeletedUsersResponse(BaseModel):
    next: Callable[[], Optional[ListDeletedUsersResponse]]

    result: DeletedUsersResponse
