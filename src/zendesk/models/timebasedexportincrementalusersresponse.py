...
class TimeBasedExportIncrementalUsersResponseTypedDict(TypedDict):
...
class TimeBasedExportIncrementalUsersResponse(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["count", "end_of_stream", "end_time", "next_page", "users"]
        )
