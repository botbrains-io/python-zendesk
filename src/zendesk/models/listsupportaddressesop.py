...
class ListSupportAddressesRequestTypedDict(TypedDict):
...
class ListSupportAddressesRequest(BaseModel):
...
class ListSupportAddressesResponseTypedDict(TypedDict):
    result: SupportAddressesResponseTypedDict


class ListSupportAddressesResponse(BaseModel):
    next: Callable[[], Optional[ListSupportAddressesResponse]]

    result: SupportAddressesResponse
