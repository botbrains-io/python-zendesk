...
class ListBrandAgentsRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["page[before]", "page[after]", "page[size]", "user_id", "brand_id"]
        )
...
class ListBrandAgentsResponseTypedDict(TypedDict):
    result: BrandAgentsResponseTypedDict


class ListBrandAgentsResponse(BaseModel):
    next: Callable[[], Optional[ListBrandAgentsResponse]]

    result: BrandAgentsResponse
