...
class ShowTicketMetricsResponseTypedDict(TypedDict):
    result: TicketMetricsByTicketMetricIDResponseTypedDict


class ShowTicketMetricsResponse(BaseModel):
    next: Callable[[], Optional[ShowTicketMetricsResponse]]

    result: TicketMetricsByTicketMetricIDResponse
