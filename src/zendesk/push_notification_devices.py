...
class PushNotificationDevices(BaseSDK):
    def push_notification_devices(
        self,
        *,
        request: Optional[
            Union[
                models.PushNotificationDevicesRequest,
                models.PushNotificationDevicesRequestTypedDict,
            ]
        ] = None,
        ...
        r"""Bulk Unregister Push Notification Devices
        ...
        * Admins
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, Optional[models.PushNotificationDevicesRequest]
            )
        request = cast(Optional[models.PushNotificationDevicesRequest], request)
    ...
    async def push_notification_devices_async(
        self,
        *,
        request: Optional[
            Union[
