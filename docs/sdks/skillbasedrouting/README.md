...
with Zendesk(
    ...
    res = z_client.skill_based_routing.list_many_agents_attribute_values(filter_agent_ids="224,225")
...
**[models.ManySkillBasedRoutingAttributeValuesResponse](../../models/manyskillbasedroutingattributevaluesresponse.md)**
