...
with Zendesk(
    ...
    res = z_client.macros.list_macros(include="usage_7d", access="personal", active=True, category=25, group_id=25, only_viewable=False, sort_by="alphabetical", sort_order="asc")
