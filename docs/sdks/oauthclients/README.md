...
* [list_o_auth_clients](#list_o_auth_clients) - List Clients
* [create_o_auth_client](#create_o_auth_client) - Create Client
* [show_client](#show_client) - Show Client
* [update_client](#update_client) - Update Client
* [delete_client](#delete_client) - Delete Client
* [client_generate_secret](#client_generate_secret) - Generate Secret
...
with Zendesk(
    ...
    res = z_client.o_auth_clients.list_o_auth_clients(page_size=100)
...
**[models.ListOAuthClientsResponse](../../models/listoauthclientsresponse.md)**
...
with Zendesk(
    ...
    res = z_client.o_auth_clients.create_o_auth_client()
...
**[models.OauthClientResponse](../../models/oauthclientresponse.md)**
...
with Zendesk(
    ...
    res = z_client.o_auth_clients.show_client(oauth_client_id=223443)
...
with Zendesk(
    ...
    res = z_client.o_auth_clients.update_client(oauth_client_id=223443)
...
<!-- UsageSnippet language="python" operationID="DeleteClient" method="delete" path="/api/v2/oauth/clients/{oauth_client_id}" -->
```python
from zendesk import Zendesk, models
...
with Zendesk(
    ...
    z_client.o_auth_clients.delete_client(oauth_client_id=223443)
...
with Zendesk(
    ...
    res = z_client.o_auth_clients.client_generate_secret(oauth_client_id=223443)
