...
<!-- UsageSnippet language="python" operationID="ListUserFields" method="get" path="/api/v2/user_fields" example="default" -->
```python
...
with Zendesk(
    ...
    res = z_client.user_fields.list_user_fields(page_size=100)
...
**[models.ListUserFieldsResponse](../../models/listuserfieldsresponse.md)**
...
<!-- UsageSnippet language="python" operationID="CreateUserField" method="post" path="/api/v2/user_fields" example="default" -->
```python
from zendesk import Zendesk, models
...
<!-- UsageSnippet language="python" operationID="ReorderUserField" method="put" path="/api/v2/user_fields/reorder" -->
```python
from zendesk import Zendesk, models
