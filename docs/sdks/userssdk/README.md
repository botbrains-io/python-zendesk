...
with Zendesk(
    ...
    res = z_client.users.list_deleted_users()
...
**[models.DeletedUsersResponse](../../models/deletedusersresponse.md)**
...
with Zendesk(
    ...
    res = z_client.users.list_users(role_query_parameter=models.UserRoleFilter.AGENT, role_query_parameter1="agent", permission_set=123, external_id="abc", page_size=100)
...
with Zendesk(
    ...
    res = z_client.users.show_user_compliance_deletion_statuses(user_id=35436, application="chat")
...
**[models.ComplianceDeletionStatusesResponse](../../models/compliancedeletionstatusesresponse.md)**
