...
with Zendesk(
    ...
    res = z_client.views.execute_view(view_id=25)
...
with Zendesk(
    ...
    res = z_client.views.list_tickets_from_view(view_id=25)
...
with Zendesk(
    ...
    res = z_client.views.preview_views()
