...
* [list_locales](#list_locales) - List Locales
* [show_locale_by_id](#show_locale_by_id) - Show Locale
* [list_locales_for_agent](#list_locales_for_agent) - List Locales for Agent
* [show_current_locale](#show_current_locale) - Show Current Locale
* [detect_best_locale](#detect_best_locale) - Detect Best Language for User
* [list_available_public_locales](#list_available_public_locales) - List Available Public Locales
...
with Zendesk(
    ...
    res = z_client.locales.list_locales()
...
**[models.LocalesResponse](../../models/localesresponse.md)**
...
with Zendesk(
    ...
    res = z_client.locales.show_locale_by_id(locale_id="es-419")
...
**[models.LocaleResponse](../../models/localeresponse.md)**
...
with Zendesk(
    ...
    res = z_client.locales.list_locales_for_agent()
...
with Zendesk(
    ...
    res = z_client.locales.show_current_locale()
...
with Zendesk(
    ...
    res = z_client.locales.detect_best_locale()
...
with Zendesk(
    ...
    res = z_client.locales.list_available_public_locales()
