...
with Zendesk(
    ...
    res = z_client.search.export_search_results(query="https://subdomain.zendesk.com/api/v2/search.json?query=type:ticket status:closed&sort_by=status&sort_order=desc")
...
**[models.SearchExportResponse](../../models/searchexportresponse.md)**
