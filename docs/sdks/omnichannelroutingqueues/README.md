...
* [list_queues](#list_queues) - List queues
* [create_queue](#create_queue) - Create Queue
* [show_queue_by_id](#show_queue_by_id) - Show Queue
* [update_queue](#update_queue) - Update Queue
* [delete_queue](#delete_queue) - Delete Queue
* [list_queue_definitions](#list_queue_definitions) - List Queue Definitions
* [reorder_queues](#reorder_queues) - Reorder Queues
...
with Zendesk(
    ...
    res = z_client.omnichannel_routing_queues.list_queues()
...
**[models.QueuesResponse](../../models/queuesresponse.md)**
...
with Zendesk(
    ...
    res = z_client.omnichannel_routing_queues.create_queue()
...
**[models.QueueResponse](../../models/queueresponse.md)**
...
with Zendesk(
    ...
    res = z_client.omnichannel_routing_queues.show_queue_by_id(queue_id="01HG80ATNNZK1N7XRFVKX48XD6")
...
with Zendesk(
    ...
    res = z_client.omnichannel_routing_queues.update_queue(queue_id="01HG80ATNNZK1N7XRFVKX48XD6")
...
with Zendesk(
    ...
    z_client.omnichannel_routing_queues.delete_queue(queue_id="01HG80ATNNZK1N7XRFVKX48XD6")
...
with Zendesk(
    ...
    res = z_client.omnichannel_routing_queues.list_queue_definitions()
...
**[models.DefinitionsResponse](../../models/definitionsresponse.md)**
...
with Zendesk(
    ...
    z_client.omnichannel_routing_queues.reorder_queues()
